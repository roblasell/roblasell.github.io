...
void makeFilters() {
  filterMenu = new FilterMenu(canvasWidth * 0.85, 0 + menuPadding, canvasWidth * 0.15 - menuPadding, (canvasHeight * 0.7) - (menuPadding * 2));
  
  console.log("OH GOD THE WIDTH IS: " + canvasWidth);
  
  float currentHeight = 0.1 * (canvasHeight * 0.7);
